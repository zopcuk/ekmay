...
'''/////////////////// MOTOR 1 ////////////////////'''
motor1_ileri = tk.Button(content, image = arrow_up, bg=col0Color, border=0, activebackground=color1)
motor1_geri = tk.Button(content, image = arrow_down, bg=col0Color, border=0, activebackground=color1)
...
'''/////////////////// MOTOR 2 ////////////////////'''
motor2_ileri = tk.Button(content, image = arrow_up, bg=col1Color, border=0, activebackground=color1)
motor2_geri = tk.Button(content, image = arrow_down, bg=col1Color, border=0, activebackground=color1)
...
'''/////////////////// MOTOR 3 ////////////////////'''
motor3_ileri = tk.Button(content, image = arrow_up, bg=col3Color, border=0, activebackground=color1)
motor3_geri = tk.Button(content, image = arrow_down, bg=col3Color, border=0, activebackground=color1)
...
'''///////////////////////PWM BUTTONS///////////////////////////'''
pwm_up = tk.Button(content, image = pwm_add, bg=col4Color, border=0, activebackground=color1)
pwm_down = tk.Button(content, image = pwm_minus, bg = col4Color, border = 0, activebackground=color1)
...
'''////////////////////////////////HOME BUTTON//////////////////////////////'''
home_button = tk.Button(content, image=reset_icon, bg=col2Color2, border=0, activebackground=color1)
def homeButtonClick(event):
    col2row2.configure(bg=color1)
    print("homeButtonClick")
def homeButtonRelease(event):
    col2row2.configure(bg=col2Color2)
...
'''////////////////////////////////LOCK BUTTON//////////////////////////////'''
lock_button = tk.Button(content, image=lock_icon, bg=col2Color2, border=0, activebackground=color1)
def lockButtonClick(event):
    col2row3.configure(bg=color1)
    print("lockButtonClick")
def lockButtonRelease(event):
    col2row3.configure(bg=col2Color2)
