...
def homePos():
    ...
    sleep(11-x)#motorlar 11 saniye pwm max 8 saniye
...
motor1_icon = motor1_icon.subsample(5, 5)

motor2_icon = tk.PhotoImage(file=r"motor2.png")
motor2_icon = motor2_icon.subsample(5, 5)

motor3_icon = tk.PhotoImage(file=r"motor3.png")
motor3_icon = motor3_icon.subsample(5, 5)

motor4_icon = tk.PhotoImage(file=r"motor4.png")
motor4_icon = motor4_icon.subsample(5, 5)
